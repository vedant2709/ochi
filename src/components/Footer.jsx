...
function Footer() {
  return (
    <div
      ...
      className="w-full h-screen bg-zinc-900 px-20 py-10  flex gap-5"
    >
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="font-['Neue_Montreal_Regular'] text-[5vw] font-semibold uppercase leading-none">
            Eye-
          </h1>
          <h1 className="font-['Neue_Montreal_Regular'] text-[5vw] font-semibold uppercase leading-none">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className="w-100 h-100 flex gap-5">
          <div className="w-1/2 h-100 flex flex-col gap-6">
            <div className="dets flex flex-col font-['Neue_Montreal_Regular'] mt-10 justify-end ">
              <div className="upper mb-4  decoration-1 text-md font-light">
                S:
              </div>
              {["Instagram", "Behance", "Facebook", "Linkedin"].map(
                (item, index) => (
                  <a
                    href=""
                    key={index}
                    className=" decoration-1 font-['Neue_Montreal_Regular'] text-md font-light"
                  >
                    {item}
                  </a>
                )
            ...
            <div className="dets flex flex-col font-['Neue_Montreal_Regular'] mt-10 w-[70%]">
              <div className="upper mb-4  decoration-1 text-md font-light">
                L:
              </div>
              {[
                ...
                <a
                  href=""
                  key={index}
                  className=" decoration-1 font-['Neue_Montreal_Regular'] text-md font-light mb-4"
                >
                  {item}
                </a>
              ))}
          ...
          <div className="w-1/2 h-100 flex flex-col items-end">
            <div className="dets flex flex-col font-['Neue_Montreal_Regular'] mt-10   w-[60%]">
              <div className="upper mb-4  decoration-1 text-md font-light">
                M:
              </div>
            ...
            <div className="dets flex flex-col font-['Neue_Montreal_Regular'] mt-10">
              <div className="upper mb-4  decoration-1 text-md font-light">
                E:
              </div>
              {["hello@ochidesign.com"].map((item, index) => (
                <a
                  href=""
                  key={index}
                  className=" decoration-1 font-['Neue_Montreal_Regular'] text-md font-light"
